...
public struct Node {
	...
	public Node(Vector2Int p, Vector2Int par, int g, int f) {
		pos = p;
		parent = par;
		gcost = g;
		fcost = f;
...
{
	public static Vector2Int[] Path(Vector2Int start,  Vector2Int end, int[] passableTeams, int downres) {
	...
	public static Node NextNode(List<Node> open, out int r) {
	...
	public static Node CreateNode(Vector2Int en, int pg, Vector2Int par, Vector2Int pos) {
	...
	public static bool IsPassable(Vector2Int pos, int[] passableTeams) {
	...
	public static bool ValidHalfPos(Vector2Int pos, int downres) {
